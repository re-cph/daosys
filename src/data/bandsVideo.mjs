...
export default [
  {
    ...
    text: "Layer 1 blockchain is the new root of all value creation in tomorrow's world of financial applications. DAOSYS formalizes a financing vehicle as a layer 1 decentralized ecosystem. With perpetual risk-mitigated growth driven by stakeholders with no central governance.",
    // image: box,
